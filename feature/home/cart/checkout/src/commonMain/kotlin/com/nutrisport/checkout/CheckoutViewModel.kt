...
import com.nutrisport.checkout.domain.Amount
import com.nutrisport.checkout.domain.PaypalApi
import com.nutrisport.checkout.domain.ShippingAddress
    ...
    val isFormValid: Boolean
        get() = with(screenState) {
            firstName.length in 3..50 &&
                    ...
                    city?.length in 3..50 == true &&
                    (postalCode?.toString()?.length in 3..8) &&
                    address?.length in 3..100 == true &&
                    phoneNumber?.number?.length in 5..15 == true
        }
            ...
            customerRepository.readCustomerFlow().collectLatest { data ->
                if (data.isSuccess()) {
                    ...
                    screenState = CheckoutScreenState(
                        ...
                        country = Country.entries.firstOrNull { it.dialCode == fetchedCustomer.phoneNumber?.countryCode }
